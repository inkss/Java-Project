    ...
    layui.use(['util', 'layer', 'table'], function () {
        $(document).ready(function () {
            ...
            var tableIns = table.render({
                elem: '#tableID',
                id: 'tableID',
                url: baseUrl + '/RoomTypeController/roomTypeTable.do',
                cols: [
                    [{
                        field: 'typeId',
                        title: 'ID',
            ...
            table.on('tool', function (obj) {
                ...
                if (layEvent === 'detail') {
                    ...
                    layer.prompt({
                        ...
                        var params = "newName=" + NewTypeName + "&oldName=" + typeName;

                        $.ajax({
                            timeout: 6000,
                            type: "POST",
                            url: baseUrl + "/RoomTypeController/queryRepeat.do",
                            data: params,
            ...
            $('#toXlsButton').click(function () {
                location.href = baseUrl + '/RoomTypeController/toExcel.do';
